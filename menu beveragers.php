...
<head>
  ...
  <title>The Gallery Cafe - Beverages</title>
...
<body>
  ...
  <div class="menu-layout-wrapper">
    ...
    <div class="menu-section section-about">
      ...
      <img src="assets/img/menu_plates/drink_coffee.png" class="floating-plate" alt="Coffee">
    </div>

    <!-- DRINKS SECTION -->
    <div class="menu-section section-menu">
      <div class="massive-title">D R I N K S</div>
      <div class="menu-card">

        <!-- Dynamic Menu Items -->
        <div class="menu-items-list">
          <?php
          $sql = "SELECT name, description, price FROM beverages ORDER BY name LIMIT 6"; 
          ...
          if ($result->num_rows > 0) {
            ...
            echo "<div>No beverages found.</div>";
          }
          ?>
        </div>

      </div>
      <img src="assets/img/menu_plates/drink_cocktail.png" class="floating-plate" alt="Cocktail">
    </div>
    ...
    <div class="menu-section section-special">
      ...
      <img src="assets/img/menu_plates/drink_juice.png" class="floating-plate" alt="Fresh Juice">
    </div>
    ...
    <div class="menu-section section-book">
      ...
      <img src="assets/img/menu_plates/drink_icedtea.png" class="floating-plate" alt="Iced Tea">
    </div>
