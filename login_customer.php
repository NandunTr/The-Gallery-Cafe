...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login_customer'])) {
    ...
    // Query to fetch user from customers table
    $sql = "SELECT * FROM customers WHERE username='$customer_username'";
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($customer_password, $stored_password)) {
        ...
        <div class="login-form-side">
            <div class="form-wrapper">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <button type="submit" class="btn-login" name="login_customer">Log in</button>
                </form>
                ...
                <div class="footer-links">
                    ...
                    <a href="customer_registation.php">Register New Account</a><br>
                    <a href="login_admin.php">Admin Login</a> | <a href="login_staff.php">Staff Login</a><br><br>
