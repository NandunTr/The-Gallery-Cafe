...
<head>
  ...
  <title>The Gallery Cafe - Staff Registration</title>
...
<body>
  ...
  <section id="staff-registration" class="staff-registration">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <form action="add_staff_acc.php" method="post" class="w-75">
  ...
  <!-- End Staff Registration Section -->
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO staff_data (firstname, lastname, birthday, contact_number, email, username, password) 
