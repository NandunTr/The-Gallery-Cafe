...
$tables = ['orders', 'beverages', 'food_menu', 'parking_spaces', 'reservations'];
$active_tab = isset($_GET['tab']) ? $_GET['tab'] : 'dashboard';
if (!in_array($active_tab, $tables) && $active_tab != 'dashboard') {
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="staff_panel.php?tab=dashboard" class="nav-item <?= $active_tab == 'dashboard' ? 'active' : '' ?>"><i class="bi bi-grid-fill"></i></a>
        <a href="staff_panel.php?tab=orders" class="nav-item <?= $active_tab == 'orders' ? 'active' : '' ?>"><i class="bi bi-receipt"></i></a>
        <a href="staff_panel.php?tab=reservations" class="nav-item <?= $active_tab == 'reservations' ? 'active' : '' ?>"><i class="bi bi-calendar-check"></i></a>
        <a href="staff_panel.php?tab=food_menu" class="nav-item <?= $active_tab == 'food_menu' ? 'active' : '' ?>"><i class="bi bi-cup-hot"></i></a>
        <a href="staff_panel.php?tab=beverages" class="nav-item <?= $active_tab == 'beverages' ? 'active' : '' ?>"><i class="bi bi-cup-straw"></i></a>
    ...
    <div class="main-wrapper">
        ...
        <div class="topbar">
            <div class="top-tabs">
                <a href="staff_panel.php?tab=dashboard" class="<?= $active_tab == 'dashboard' ? 'active' : '' ?>">Dashboard</a>
                <a href="staff_panel.php?tab=orders" class="<?= $active_tab == 'orders' ? 'active' : '' ?>">Orders</a>
                <a href="staff_panel.php?tab=reservations" class="<?= $active_tab == 'reservations' ? 'active' : '' ?>">Reservations</a>
                <a href="staff_panel.php?tab=food_menu" class="<?= $active_tab == 'food_menu' ? 'active' : '' ?>">Menu</a>
                <a href="staff_panel.php?tab=beverages" class="<?= $active_tab == 'beverages' ? 'active' : '' ?>">Beverages</a>
            </div>
            <div class="top-actions">
                <i class="bi bi-search"></i>
                <i class="bi bi-bell"></i>
                <div class="avatar">
                    <img src="https://ui-avatars.com/api/?name=Staff&background=108c5a&color=fff" alt="Staff">
                </div>
            </div>
        </div>
        ...
        <div class="header-section">
            <div class="welcome-text">Welcome Back, <span>Staff</span></div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="left-col">
                ...
                <div class="card">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <a href="staff_panel.php?tab=orders" style="color: var(--text-muted); text-decoration: none;"><i class="bi bi-box-arrow-up-right"></i></a>
                    </div>
            ...
            <div class="right-col">
                <div class="card" style="margin-bottom: 30px;">
                    <div class="card-title" style="color: var(--text-main)">Reservations</div>
                    <div class="card-subtitle">Manage table bookings</div>
                    
                    <?php
                    $res_count = 0;
                    try {
                        $res_q = $conn->query("SELECT COUNT(*) as c FROM reservations");
                        if($res_q) { 
                    ...
                    ?>
                    <div class="card-value" style="font-size: 28px; margin-top:20px;"><?= $res_count ?> Bookings</div>
                    
                    <div style="margin-top: 30px; display: flex; gap: 10px;">
                        <a href="book_table.php" class="btn-add" style="background: var(--primary-green); color: white; flex:1; justify-content:center">Book Table</a>
                    </div>
                </div>
            </div>
